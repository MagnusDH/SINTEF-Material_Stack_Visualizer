...
import os
import json
import matplotlib.pyplot as matplot #For creating graphs

#1< hs <1000 000E-9 == 1*10 opphøyd i minus9 til 1000000*10 opphøyd i minus9

#TODO
    #Lag ny widget som skal vise bølgelengder
    #Lag en slidebar som endrer "h" og går fra (1*10 opphøyd i minus9 til 1000000*10 opphøyd i minus 9)
